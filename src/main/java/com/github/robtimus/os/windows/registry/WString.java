...
final class WString {
    ...
    static MemorySegment allocate(SegmentAllocator allocator, int size) {
    ...
    static MemorySegment target(MemorySegment ref, int length) {
    ...
    static MemorySegment allocate(SegmentAllocator allocator, List<String> values) {
